...
return [
    ...
    'attributes'           => [
        ...
        'country_id' => 'الجنسية',
        'dr_id' => 'الطبيب',
        'diagnosis.taken' => 'التشخيص',
        'diagnosis.treatment' => 'العلاج',
        'diagnosis.tooth' => 'الأسنان',
        'clinic_id' => 'العيادة',
        'appointment_time' => 'وقت الموعد',
        'patient_id' => 'المريض',
        'appointment_date' => 'تاريخ الموعد',
        'appointment_duration' => 'الفترة',
        'password' => 'كلمة السر',
        'email' => 'البريد الاكتروني',
        'type' => 'نوع الوظيفة',
        'group' => 'المجموعة',
        'salary' => 'الراتب',
        'invoice_paid' => 'اجمالي الفواتير المسدده',
        'rate' => 'النسبة',
        'doctor_id' => 'الطبيب',
