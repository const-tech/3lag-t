<div class="d-flex gap-2 mb-2">
    ...
    <button class="btn btn-sm text-white btn-info btn-sm"
        wire:click='$set("invoice_status","paid")'>{{ __('admin.Paid') }}
            ...
            @foreach ($invoices as $invoice)
                <tr>
                    ...
                    <td><a href="" class="btn btn-sm btn-info text-white">
                        ...
                        <a target="_blank" href="{{ route('doctor.invoices.show', $invoice) }}"
