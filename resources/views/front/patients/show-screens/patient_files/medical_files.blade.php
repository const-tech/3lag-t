...
<div class="table-responsive">
    <table class="table main-table">
        ...
        <tbody>
            @foreach ($patient->medical_files()->paginate(10) as $file)
                <tr>
                    <td>{{ $file->id }}</td>
                ...
                <!-- Modal Add File -->
                <div class="modal fade" id="delete_agent{{ $file->id }}" tabindex="-1"
    ...
    {{ $patient->medical_files()->paginate(10)->links() }}
</div>
            ...
            <div class="modal-body">
                <div class="row row-gap-24">
                    <div class="col-12">
                        ...
                        <input class="form-control" type="text" wire:model="file_name" id="">
                    </div>
                    <div class="col-12">
                        <label for="">{{ __('admin.file') }}</label>
                        <input class="form-control" type="file" wire:model="file" id="">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button class="btn btn-sm   btn-primary" data-bs-dismiss="modal"
                    wire:click='save_file'>{{ __('admin.Yes') }}</button>
            </div>
