<div class="modal fade" id="show{{ $diagnose->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    wire:ignore.self>
            ...
            <div class="modal-body">
                <div class="row row-gap-24">
                    <div class="col-12">
                        ...
                        <textarea readonly class="w-100 form-control" id="diagnosis">{{ $diagnose->chief_complain }}</textarea>
                    </div>
                    <div class="col-12">
                        <label for="diagnosis" class="option-name mb-2">{{ __('Sign and symptom') }} :</label>
                        <textarea readonly class="w-100 form-control" id="diagnosis">{{ $diagnose->sign_and_symptom }}</textarea>
                    </div>
                    <div class="col-12">
                        <label for="diagnosis" class="option-name mb-2">{{ __('Other') }} :</label>
                        <textarea readonly class="w-100 form-control" id="diagnosis">{{ $diagnose->other }}</textarea>
                    </div>
                    <div class="col-12">
                    ...
                    @if ($diagnose->tooth)
                        <div class="col-12">
                            <label for="action-taken" class="option-name mb-2">{{ __('admin.Tooth') }} :</label>
