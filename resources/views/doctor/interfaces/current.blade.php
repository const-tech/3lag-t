 <section class="p-3 row">
    <section class="form-group col-12 col-md-6 mb-3 {{ setting()->complaint?'':'d-none' }}">
    ...
    <section class="form-group col-12 col-md-6 mb-3">
    ...
    <section class="form-group col-12 col-md-6 mb-3">
     ...
     {{-- treatment --}}
     <section class="form-group col-12 my-3">
