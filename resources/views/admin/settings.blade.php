...
<form class="row row-gap-24 p-3 shadow rounded-3 bg-white w-100 mx-auto" action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="col-12">
    ...
    <div class="form-group col-sm-6 col-md-3">
        ...
        <input type="text" name="site_name" placeholder="{{ __('admin.Site name') }}" class="form-control" value="{{ setting()->site_name }}">
    </div>
    <div class="form-group col-sm-6 col-md-3">
        <label class="main-lable" for="">{{ __('admin.url') }}</label>
        <input type="url" name="url" placeholder="{{ __('admin.url') }}" class="form-control" value="{{ setting()->url }}">
    </div>
    <div class="form-group col-sm-6 col-md-3">
    ...
    <div class="form-group col-sm-6 col-md-3">
        ...
        <input type="text" name="phone" placeholder="{{ __('admin.phone') }}" class="form-control" value="{{ setting()->phone }}">
    </div>
    <div class="form-group col-sm-6 col-md-3">
        <label class="main-lable" for="">{{ __('admin.SMS Username') }}</label>
        <input type="text" name="sms_username" placeholder="{{ __('admin.SMS Username') }}" class="form-control" value="{{ setting()->sms_username }}">
    </div>
    {{-- <div class="form-group col-sm-6 col-md-3">
    ...
    <div class="form-group col-sm-6 col-md-3">
        ...
        <input type="email" name="email" placeholder="{{ __('admin.email') }}" class="form-control" value="{{ setting()->email }}">
    </div>
    <div class="form-group col-sm-6 col-md-3">
    ...
    <div class="form-group col-sm-6 col-md-3">
        ...
        <input type="number" name="tax_rate" placeholder="{{ __('admin.Tax rate') }}" class="form-control" value="{{ setting()->tax_rate }}" step="0.01">
    </div>
    <div class="form-group col-sm-6 col-md-3">
        <label class="main-lable" for="">{{ __('admin.Tax number') }}</label>
        <input type="text" name="tax_no" placeholder="{{ __('admin.Tax number') }}" class="form-control" value="{{ setting()->tax_no }}">
    </div>
    <div class="form-group col-sm-6 col-md-3">
        <label class="main-lable" for="">{{ __('admin.address') }}</label>
        <input type="text" name="address" placeholder="{{ __('admin.address') }}" class="form-control" value="{{ setting()->address }}">
    </div>
    <div class="form-group col-sm-6 col-md-3">
        <label class="main-lable" for="">{{ __('admin.Build number') }}</label>
        <input type="text" name="build_num" placeholder="{{ __('admin.Build number') }}" class="form-control" value="{{ setting()->build_num }}">
    </div>
    <div class="form-group col-sm-6 col-md-3">
        <label class="main-lable" for="">{{ __('admin.Unit number') }}</label>
        <input type="text" name="unit_num" placeholder="{{ __('admin.Unit number') }}" class="form-control" value="{{ setting()->unit_num }}">
    </div>
    <div class="form-group col-sm-6 col-md-3">
        <label class="main-lable" for="">{{ __('admin.Postal code') }}</label>
        <input type="text" name="postal_code" placeholder="{{ __('admin.Postal code') }}" class="form-control" value="{{ setting()->postal_code }}">
    </div>

    <div class="form-group col-sm-6 col-md-3">
        <label class="main-lable" for="">{{ __('admin.Extra number') }}</label>
        <input type="text" name="extra_number" placeholder="{{ __('admin.Extra number') }}" class="form-control" value="{{ setting()->extra_number }}">
    </div>
    <?php $setting = \App\Models\Setting::latest()->first(); ?>
    <div class="form-group col-sm-6 col-md-3">
        <label class="main-lable" for="">{{ __('admin.Logo') }}</label>
        <input type="file" name="logo" placeholder="{{ __('admin.Logo') }}" class="form-control img" value="{{ $setting->logo ?? null }}">
        <img src="{{ display_file(setting()->logo) }}" alt="{{ $setting->logo ?? null }}" class="img-thumbnail img-preview" width="100px">
    </div>
    <div class="form-group col-sm-6 col-md-3">
        <label class="main-lable" for="">{{ __('admin.Icon') }}</label>
        <input type="file" name="icon" placeholder="{{ __('admin.Icon') }}" class="form-control">
        <img src="{{ display_file(setting()->icon) }}" alt="{{ $setting->icon ?? null }}" class="img-thumbnail img-preview" width="100px">
    </div>
    <div class="form-group col-sm-6 col-md-3">
        <label class="main-lable" for="">{{ __('capital') }} </label>
        <input type="number" name="capital" placeholder="{{ __('capital') }}" class="form-control" value="{{ setting()->capital }}">
    </div>
    ...
    <div class="form-group col-sm-6 col-md-3 mt-4">
        ...
        <input type="checkbox" name="activate_birthdate" value="1" {{ setting()->activate_birthdate ? 'checked' : '' }}>
    </div>
    <div class="form-group col-sm-6 col-md-6">
        {{-- <label class="main-lable" for="">{{ __('age_or_gender') }} </label> --}}
        <label for="" class="p-2">
            عرض حقول الجنس
            <input type="radio" name="age_or_gender" value="sex" id="" {{ setting()->age_or_gender == 'sex' ? 'checked' : '' }}>
        </label>
        <label for="" class="p-2">
            عرض حقول العمر
            <input type="radio" name="age_or_gender" value="age" {{ setting()->age_or_gender == 'age' ? 'checked' : '' }} id="">
        </label>
        <label for="" class="p-2">
            عرض العمر و الجنس
            <input type="radio" name="age_or_gender" value="all" {{ setting()->age_or_gender == 'all' ? 'checked' : '' }} id="">
        </label>
    ...
    <div class="form-group col-12">
        ...
        <input type="checkbox" name="new_invoice_form" value="1" {{ setting()->new_invoice_form ? 'checked' : '' }}>
    </div>
    ...
    <div class="form-group col-sm-6 col-md-3">
        ...
        <input type="text" name="installment_company_name" placeholder="اسم الشركة" class="form-control" value="{{ setting()->installment_company_name }}">
    </div>
    <div class="form-group col-sm-6 col-md-3">
        <label class="main-lable" for="">رسوم العمليات الادارية</label>
        <input type="number" name="installment_company_tax" placeholder="رسوم العمليات الادارية" class="form-control" value="{{ setting()->installment_company_tax }}" step="0.01">
    </div>
    <div class="form-group col-sm-6 col-md-3">
        <label class="main-lable" for="">رسوم أقل مبلغ</label>
        <input type="number" name="installment_company_min_amount_tax" placeholder="رسوم أقل مبلغ" class="form-control" value="{{ setting()->installment_company_min_amount_tax }}" step="0.01">
    </div>
    <div class="form-group col-sm-6 col-md-3">
        <label class="main-lable" for="">رسوم أعلى مبلغ</label>
        <input type="number" name="installment_company_max_amount_tax" placeholder="رسوم أعلى مبلغ" class="form-control" value="{{ setting()->installment_company_max_amount_tax }}" step="0.01">
    </div>
    <div class="form-group col-12">
        <label class="main-lable" for="">تفعيل بوابات الدفع</label>
        <input type="checkbox" name="payment_gateways" value="1" {{ setting()->payment_gateways ? 'checked' : '' }}>
    </div>
    <div class="col-md-12 text-center mt-3">
    ...
    <div class="form-group col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="time" name="from_morning" class="form-control" value="{{ setting()->from_morning }}">
            </div>
            <div class="col-md-6">
    ...
    <div class="form-group col-md-6 ">
        ...
        <div class="row">
            <div class="col-md-4">
                <label class="main-lable" for="">{{ __('admin.from') }}</label>
                <input type="time" name="from_evening" id="from_evening" class="form-control" value="{{ setting()->from_evening }}">

            </div>
            <div class="col-md-4">
                <label class="main-lable" for="">{{ __('admin.to') }}</label>
                <input type="time" name="to_evening" id="to_evening" class="form-control" value="{{ setting()->to_evening }}">

            </div>
            <div class="col-md-4">
                <label class="main-lable" for="">{{ __('admin.evening_status') }}</label>
                <input type="hidden" name="evening_status" value="0">
                <input type="checkbox" {{ setting()->evening_status ? 'checked' : '' }} name="evening_status" id="evening_status" class="form-check" value="1">
            </div>
        </div>
    </div>
