<div class="modal fade" id="delete_agent{{$relationship->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.relationships.destroy',$relationship) }}" method="POST">
                @csrf
                @method('DELETE')
