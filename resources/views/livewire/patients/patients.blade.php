<section class="main-section users">
    ...
    <div class="container" id="data-table">
        ...
        <div class="bg-white shadow p-4 rounded-3">
            <div
                class="amountPatients-holder gap-2 d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
                <div class="d-flex flex-column flex-md-row">
                    ...
                    <div class="py-2 px-3 bg-info rounded text-white" style="cursor: pointer"
                        wire:click='$toggle("filter_visit")'>
                    ...
                    <div class="col-md-10 d-flex flex-column flex-md-row gap-2 px-0">
                        <div dir="ltr" class="input-group mb-2 mb-md-0">
                            ...
                            <input dir="rtl" type="text" class="form-control" wire:model='civil'
                                placeholder=" {{ __('admin.ID number search') }}" />
                        </div>
                        ...
                        <div dir="ltr" class="input-group mb-2 mb-md-0">
                            ...
                            <input dir="rtl" type="text" class="form-control" wire:model='phone'
                                placeholder="{{ __('admin.Mobile number search') }}" />
                        </div>
                        ...
                        <div dir="ltr" class="input-group ms-2 mb-2 mb-md-0">
                            ...
                            <input dir="rtl" type="text" class="form-control" wire:model='first_name'
                                placeholder="  {{ __('admin.Search by firstname') }}" />
                        </div>
                    </div>
                    @can('اضافة مريض')
                        ...
                        <tbody>
                            @foreach ($patients as $patient)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('front.invoices.index', ['patient_id' => $patient->id, 'status' => 'Partially Paid']) }}"
                                            class="btn btn-sm btn-outline-secondary">
