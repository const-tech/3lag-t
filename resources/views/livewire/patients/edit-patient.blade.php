                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <div class="Patient-info right-side">
                            ...
                            <div class="fild-control mb-3">
                                <label for="" class="small-label fs-11px">يمكنك اضافة مجموعه مسبقة من الادارة
                                    <br> وهي خاصه بالمرضى الذي لديهم عروض مثال ، طلاب المدارس / الجامعات ،
                                    الموظفين</label>
                    ...
                    <div class="col-md-6">
                        <div class="Patient-info left-side">
                            ...
                            <div class="fild-control mb-3">
                                ...
                                <input type="text" class="birh-date form-control" readonly value="{{ $birthdate? Carbon::parse($birthdate)->toHijri()->isoFormat('DD-MMMM-YYYY'): '' }}" placeholder="{{ __('admin.Hijri date of birth') }}" />
                            </div>
                    ...
                    <div class="data-content" wire:ignore.self>
                        <div wire:ignore.self>
                            ...
                            <div>
                                ...
                                <div class="radioarea d-flex">
                                    <label class="radio-inline ms-2">
                                        <input type="radio" wire:model="pressure" id="sensitivity_penicillin1" value="1" />
                                        <span>{{ __('Yes') }}</span>
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" wire:model="pressure" id="sensitivity_penicillin2" value="0" />
                                        <span>{{ __('No') }}</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="radioarea d-flex">
                                    <label class="radio-inline ms-2">
                                        <input type="radio" wire:model="sugar" id="sensitivity_penicillin1" value="1" />
                                        <span>{{ __('Yes') }}</span>
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" wire:model="sugar" id="sensitivity_penicillin2" value="0" />
                                        <span>{{ __('No') }}</span>
                                    </label>
                                </div>
                            </div>
