    ...
    public function run()
    {
        $data = [
            [
                ...
                ادخال جميع البينات ورفع شعار العيادة  مع ضبط وقت العمل',
            ],
            [
            ...
            [
                'question' => 'إضافة موظف',
                'answer' => '-	يمكن إضافة موظف من لوحة التحكم مع اختيار القسم والمجموعة واضافة الراتب والنسبة او جعل القيمة صفر مع تحديد الخيارات في حال كان طبيب العلاج الطبعي او جلدية لكي يظهر نموذج القسم صورة .
